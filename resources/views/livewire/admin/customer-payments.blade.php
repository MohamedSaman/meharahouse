        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-[#0F172A] font-[Poppins] mt-0.5">
                    {{ number_format($stats['total_receivable'], 2) }} <span class="text-sm font-medium text-slate-400">Rs.</span>
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-emerald-600 font-[Poppins] mt-0.5">
                    {{ number_format($stats['total_received'], 2) }} <span class="text-sm font-medium text-slate-400">Rs.</span>
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-amber-600 font-[Poppins] mt-0.5">
                    {{ number_format($stats['total_outstanding'], 2) }} <span class="text-sm font-medium text-slate-400">Rs.</span>
                </p>
            </div>
        </div>
    </div>
                        ...
                        <select wire:model.live="orderId"
                            ...
                            @foreach ($recentOrders as $order)
                                <option value="{{ $order->id }}">
                                    {{ $order->order_number }} &mdash; {{ number_format($order->total, 2) }} Rs.
                                </option>
                            @endforeach
                        </select>
